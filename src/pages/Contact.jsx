          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex overflow-x-auto">
              <button
                ...
                className={`px-6 py-4 font-medium whitespace-nowrap border-b-2 ${activeTab === 'about' ? 'text-blue-600 border-blue-600' : 'text-gray-500 border-transparent hover:text-blue-500'}`}
              >
                Nuestra Institución
              </button>
              <button
                onClick={() => setActiveTab('contact')}
                className={`px-6 py-4 font-medium whitespace-nowrap border-b-2 ${activeTab === 'contact' ? 'text-blue-600 border-blue-600' : 'text-gray-500 border-transparent hover:text-blue-500'}`}
              >
                Contacto
              </button>
              <button
                onClick={() => setActiveTab('faq')}
                className={`px-6 py-4 font-medium whitespace-nowrap border-b-2 ${activeTab === 'faq' ? 'text-blue-600 border-blue-600' : 'text-gray-500 border-transparent hover:text-blue-500'}`}
              >
              ...
              <div>
                ...
                <div className="prose prose-blue max-w-none">
                  <p className="text-lg text-gray-700 mb-4">
                    Somos estudiantes de <strong> FUNDACION KINAL </strong> , siguiendo la carrera de Perito en informática con más de <strong>2 años aprendiendo programacion</strong>.
                  </p>
                  <p className="text-lg text-gray-700 mb-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white rounded-lg shadow-sm p-4 flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-blue-600 text-sm">acarrillo@valmeria.com</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm p-4 flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-blue-600 text-sm">lcuxunz@valmeria.com</p>
                    </div>
                  </div>
                   <div className="bg-white rounded-lg shadow-sm p-4 flex items-center">
                    <div className="bg-blue-100 text-blue-800 rounded-full w-12 h-12 flex items-center justify-center mr-4 font-bold">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm"> Backend</p>
                      <p className="text-blue-600 text-sm">gcontreras@valmeria.com</p>
                    </div>
                  </div>
                   <div className="bg-white rounded-lg shadow-sm p-4 flex items-center">
                    <div className="bg-blue-100 text-blue-800 rounded-full w-12 h-12 flex items-center justify-center mr-4 font-bold">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm"> Fronted</p>
                      <p className="text-blue-600 text-sm">jcipriano@valmeria.com</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-6 md:mb-0">
                <div className="flex items-center">
                  <svg className="w-8 h-8 text-blue-300 mr-2" fill="currentColor" viewBox="0 0 24 24">
