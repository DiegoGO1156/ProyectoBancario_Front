...
import DeleteProductConfirmationModal from "./DeleteProductModal";
    ...
    return (
        <div className="space-y-8 p-6 animate-fade-in">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500 font-medium">
                            Mostrando <span className="text-blue-600 font-bold">{filteredProducts.length}</span> de <span className="text-gray-700">{products.length}</span> productos
                        </p>
                    </div>
            ...
            {filteredProducts.length === 0 ? (
                <div className="bg-white rounded-xl shadow-lg p-8 text-center animate-pulse">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                        {searchTerm ? 'Intenta con otro término de búsqueda' : 'Agrega tu primer producto para comenzar'}
                    </p>
                    <button 
                        onClick={fetchProducts}
            ...
            <DeleteProductConfirmationModal
                ...
                itemName={selectedProduct?.nameProduct || ''}
                itemType="producto"
            /> 
        </div>
    );
...
const ProductCard = ({ product, onEdit, onDelete, isHovered, onMouseEnter, onMouseLeave }) => {
    return (
        <div 
        ...
        >
            ...
            <div className="p-5">
                ...
                <div className="flex justify-between items-center mt-3">
                    ...
                    {product.status ? (
                        <span className="text-xs px-2 py-1 bg-green-100 text-green-800 rounded-full">Disponible</span>
                    ) : (
                        <span className="text-xs px-2 py-1 bg-red-100 text-red-800 rounded-full">No disponible</span>
                    )}
                </div>
